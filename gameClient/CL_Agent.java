...
public class CL_Agent {
	...
	//	private long _key;
		...
		public CL_Agent(int id ,double v,int src,int dest,double speed ,geo_location geo) 
		{
			this._id = id;
			this._value = v;
			this._speed = speed;
			this._pos = geo;
			this._curr_edge = new EdgeData(src, dest, 0);
			this._curr_node = new NodeData(src);
		}
		...
		public void set_curr_edge(EdgeData e) 
		{
			this._curr_edge = e;
		}
	}